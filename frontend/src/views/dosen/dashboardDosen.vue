<template>
    ...
    <gen-table :aksi.Boolean="false" :refreshButton.Boolean="false" :exportButton.Boolean="false" :formButton.Boolean="false" :url="url" :tableContent="tableContent" tableType="lain"></gen-table>
    </div>
  </div>
  </div>
  </div>
