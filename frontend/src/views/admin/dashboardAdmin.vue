<template>
    ...
    <gen-table :aksi.Boolean="false" :refreshButton.Boolean="false" :exportButton.Boolean="false" :pk="tableContent[0].name" :formButton.Boolean="false" :url="url" :tableContent="tableContent" tableType="lain"></gen-table>
    </div>
  </div>
  </div>
  </div>
