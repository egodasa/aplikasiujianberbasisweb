...
--
-- Name: tbkuliah_mahasiswa; Type: TABLE; Schema: public; Owner: mandan
--

CREATE TABLE tbkuliah_mahasiswa (
...
CREATE VIEW lap_kuliah_mahasiswa AS
 SELECT a.id_kuliah,
    a.nobp,
    c.nm_mahasiswa,
    a.status,
...
--
-- Name: tbkuliah_mahasiswa_id_kmhs_seq; Type: SEQUENCE; Schema: public; Owner: mandan
--

CREATE SEQUENCE tbkuliah_mahasiswa_id_kmhs_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE tbkuliah_mahasiswa_id_kmhs_seq OWNER TO mandan;

--
-- Name: tbkuliah_mahasiswa_id_kmhs_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mandan
--

ALTER SEQUENCE tbkuliah_mahasiswa_id_kmhs_seq OWNED BY tbkuliah_mahasiswa.id_kmhs;
...
ALTER TABLE ONLY tbkuliah_mahasiswa ALTER COLUMN id_kmhs SET DEFAULT nextval('tbkuliah_mahasiswa_id_kmhs_seq'::regclass);
...
SELECT pg_catalog.setval('tbkuliah_id_kuliah_seq', 7, true);


--
-- Data for Name: tbkuliah_mahasiswa; Type: TABLE DATA; Schema: public; Owner: mandan
--

COPY tbkuliah_mahasiswa (id_kmhs, id_kuliah, nobp, status) FROM stdin;
...
--
-- Name: tbkuliah_mahasiswa_id_kmhs_seq; Type: SEQUENCE SET; Schema: public; Owner: mandan
--

SELECT pg_catalog.setval('tbkuliah_mahasiswa_id_kmhs_seq', 24, true);
...
COPY tbujian (id_ujian, id_kuliah, hari, id_jujian, id_jsoal, mulai, selesai, deskripsi) FROM stdin;
4	5	2017-11-21	1	1	08:00:00	10:00:00	Ujian
5	6	2017-11-21	1	2	08:00:00	10:00:00	Ujian
6	7	2017-11-21	1	2	08:00:00	10:00:00	Ujian
\.
...
SELECT pg_catalog.setval('tbujian_id_ujian_seq', 6, true);
...
--
-- Name: tbkuliah_mahasiswa_id_kmhs; Type: CONSTRAINT; Schema: public; Owner: mandan
--

ALTER TABLE ONLY tbkuliah_mahasiswa
    ADD CONSTRAINT tbkuliah_mahasiswa_id_kmhs PRIMARY KEY (id_kmhs);
