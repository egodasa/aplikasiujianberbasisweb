...
CREATE SEQUENCE tbkelas_id_kelas_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
CREATE SEQUENCE tbdosen_id_dosen_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbdosen" ("id_dosen", "nidn", "nm_dosen") VALUES
(2,	'23232',	'dsds'),
...
CREATE SEQUENCE tbjenis_ujian_id_jujian_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbjenis_ujian" ("id_jujian", "nm_jenis") VALUES
(1,	'UAS'),
(2,	'UTS'),
(3,	'Lain-lain');

DROP TABLE IF EXISTS "tbtipe_soal";
CREATE SEQUENCE tipe_soal_id_tsoal_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbtipe_soal" ("id_tsoal", "nm_tipe") VALUES
(1,	'Pilihan Ganda'),
(2,	'Essai');

DROP TABLE IF EXISTS "tbsoal";
CREATE SEQUENCE mahasiswa_id_mahasiswa_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbsoal" ("id_soal", "isi_soal", "jawaban", "pilihanGanda", "id_tsoal", "bobot") VALUES
(2,	'Ayam adalah?',	'Ayam adalah hewan berkaki 2',	NULL,	2,	1),
(7,	'Bara kaki gajah?',	'ampek da',	NULL,	2,	1),
(10,	'Bara kaki anjiang?',	'B',	NULL,	2,	10),
(11,	'pantek kau',	'fak yu',	NULL,	2,	20),
(1,	'Berapakah kaki kucing?',	'A',	'[{"huruf":"A","isi_pilihan":"4"},{"huruf":"B","isi_pilihan":"3"},{"huruf":"C","isi_pilihan":"2"}]',	1,	1),
(12,	'mkmkkm',	'qwqwqwq',	NULL,	2,	20),
...
(25,	'mandul',	'gundul',	NULL,	2,	20),
(26,	'mandul',	'gundul',	NULL,	2,	20),
(27,	'dafuk',	'gundul',	NULL,	2,	20),
(28,	'gundulmu',	'gigi',	NULL,	2,	20),
(29,	'anumu',	'gundulmu',	NULL,	2,	20),
(30,	'momo',	'mumu',	NULL,	2,	21),
(31,	'Sistem adalah?',	'Sekumpulan elemen yang bekerja sama untuk mencapai sebuah tujuan',	NULL,	2,	15);

DROP TABLE IF EXISTS "tbmatkul";
CREATE SEQUENCE matkul_id_matkul_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbmatkul" ("id_matkul", "nm_matkul", "sks", "smt") VALUES
...
CREATE SEQUENCE tbmahasiswa_id_mahasiswa_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbmahasiswa" ("id_mahasiswa", "nobp", "nm_mahasiswa", "id_kelas", "status") VALUES
...
CREATE SEQUENCE tbkuliah_id_kuliah_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbkuliah" ("id_kuliah", "id_dosen", "id_matkul", "id_kelas", "thn_ajaran") VALUES
(3,	2,	3,	3,	20171),
(8,	333,	4,	3,	20171);

DROP TABLE IF EXISTS "tbkuliah_mhs";
CREATE SEQUENCE tbkuliah_mhs_id_kmhs_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbkuliah_mhs" ("id_kmhs", "id_mahasiswa", "id_kuliah") VALUES
(6,	1,	3),
(7,	2,	8),
(8,	3,	8),
(10,	2,	3),
...
CREATE SEQUENCE tbujian_id_ujian_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbujian" ("id_ujian", "id_kuliah", "id_tsoal", "deskripsi", "id_jujian", "durasi_ujian") VALUES
(3,	3,	1,	'ANuu',	2,	3600000),
(4,	8,	2,	'Test',	1,	3600000);

DROP TABLE IF EXISTS "tbsoal_ujian";
CREATE SEQUENCE tbsoal_ujian_id_sujian_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO "tbsoal_ujian" ("id_sujian", "id_ujian", "id_soal") VALUES
(6,	3,	21),
(7,	3,	22),
(13,	2,	28),
(15,	2,	30),
...
CREATE TABLE "lap_kuliah_mhs" ("id_kmhs" integer, "id_kuliah" integer, "id_mahasiswa" integer, "nobp" character(14), "nm_mahasiswa" character varying(100));


DROP TABLE IF EXISTS "tbjawaban";
CREATE SEQUENCE tbjawaban_id_jawaban_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."tbjawaban" (
    "id_jawaban" integer DEFAULT nextval('tbjawaban_id_jawaban_seq') NOT NULL,
    "id_ujian" integer NOT NULL,
    "id_soal" integer NOT NULL,
    ...
    CONSTRAINT "tbjawaban_id_ujian_fkey" FOREIGN KEY (id_ujian) REFERENCES tbujian(id_ujian) ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE
) WITH (oids = false);

CREATE INDEX "tbjawaban_id_peserta" ON "public"."tbjawaban" USING btree ("id_peserta");

CREATE INDEX "tbjawaban_id_soal" ON "public"."tbjawaban" USING btree ("id_soal");

CREATE INDEX "tbjawaban_id_ujian" ON "public"."tbjawaban" USING btree ("id_ujian");

INSERT INTO "tbjawaban" ("id_jawaban", "id_ujian", "id_soal", "id_peserta", "jawaban") VALUES
(16,	4,	31,	2,	'anumu');

DROP TABLE IF EXISTS "tbhasil_ujian";
CREATE SEQUENCE tbhasil_ujian_id_hasil_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."tbhasil_ujian" (
    "id_hasil" integer DEFAULT nextval('tbhasil_ujian_id_hasil_seq') NOT NULL,
    "id_ujian" integer NOT NULL,
    "id_peserta" integer NOT NULL,
    "nilai" integer DEFAULT 0 NOT NULL,
    CONSTRAINT "tbhasil_ujian_id_hasil" PRIMARY KEY ("id_hasil"),
    CONSTRAINT "tbhasil_ujian_id_ujian_fkey" FOREIGN KEY (id_ujian) REFERENCES tbujian(id_ujian) ON UPDATE CASCADE NOT DEFERRABLE
) WITH (oids = false);

CREATE INDEX "tbhasil_ujian_id_peserta" ON "public"."tbhasil_ujian" USING btree ("id_peserta");

CREATE INDEX "tbhasil_ujian_id_ujian" ON "public"."tbhasil_ujian" USING btree ("id_ujian");

INSERT INTO "tbhasil_ujian" ("id_hasil", "id_ujian", "id_peserta", "nilai") VALUES
(1,	3,	1,	50),
(3,	4,	2,	5);

DROP VIEW IF EXISTS "lap_kuliah";
CREATE TABLE "lap_kuliah" ("id_kuliah" integer, "id_matkul" integer, "nm_matkul" character varying(30), "id_dosen" integer, "nidn" character varying(10), "nm_dosen" character varying(100), "nm_kelas" character varying(10));


DROP VIEW IF EXISTS "lap_hasil_ujian";
CREATE TABLE "lap_hasil_ujian" ("id_hasil" integer, "id_ujian" integer, "id_peserta" integer, "nilai" integer, "nm_mahasiswa" character varying(100), "nobp" character(14));


DROP VIEW IF EXISTS "lap_status_ujian_mhs";
CREATE TABLE "lap_status_ujian_mhs" ("id_mahasiswa" integer, "nobp" character(14), "nm_mahasiswa" character varying(100), "status" boolean, "id_tsoal" integer);


DROP VIEW IF EXISTS "lap_peserta_ujian";
CREATE TABLE "lap_peserta_ujian" ("id_ujian" integer, "id_mahasiswa" integer, "nobp" character(14), "nm_mahasiswa" character varying(100));


DROP VIEW IF EXISTS "lap_jawaban";
CREATE TABLE "lap_jawaban" ("id_jawaban" integer, "id_ujian" integer, "id_soal" integer, "id_peserta" integer, "isi_soal" text, "jawaban" text, "jawaban_peserta" text, "bobot" smallint);


DROP TABLE IF EXISTS "tbuser";
CREATE SEQUENCE tbuser_id_user_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."tbuser" (
    "id_user" integer DEFAULT nextval('tbuser_id_user_seq') NOT NULL,
    "username" character varying(15) NOT NULL,
    "password" text NOT NULL,
    "id_tipe" integer NOT NULL,
    CONSTRAINT "tbuser_id_user" PRIMARY KEY ("id_user")
) WITH (oids = false);

INSERT INTO "tbuser" ("id_user", "username", "password", "id_tipe") VALUES
...
DROP TABLE IF EXISTS "tbtipe_user";
CREATE SEQUENCE tbtipe_user_id_tipe_seq INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;

CREATE TABLE "public"."tbtipe_user" (
    "id_tipe" integer DEFAULT nextval('tbtipe_user_id_tipe_seq') NOT NULL,
    "nm_tipe" character varying(15) NOT NULL
) WITH (oids = false);

INSERT INTO "tbtipe_user" ("id_tipe", "nm_tipe") VALUES
(1,	'Admin'),
(2,	'Dosen');

DROP VIEW IF EXISTS "lap_user";
CREATE TABLE "lap_user" ("id_user" integer, "username" character varying(15), "password" text, "id_tipe" integer, "nm_tipe" character varying(15));


DROP VIEW IF EXISTS "lap_ujian";
CREATE TABLE "lap_ujian" ("id_ujian" integer, "id_kuliah" integer, "nm_matkul" character varying(30), "nidn" character varying(10), "nm_dosen" character varying(100), "nm_kelas" character varying(10), "id_tsoal" integer, "nm_tipe" character varying(15), "nm_jenis" character varying(10), "jam" double precision, "menit" integer);
...
CREATE TABLE "public"."lap_kuliah" (
    ...
    "nm_dosen" character varying(100),
    "nm_kelas" character varying(10)
) WITH (oids = false);

DROP TABLE IF EXISTS "lap_hasil_ujian";
CREATE TABLE "public"."lap_hasil_ujian" (
    "id_hasil" integer,
    "id_ujian" integer,
    "id_peserta" integer,
    "nilai" integer,
...
DROP TABLE IF EXISTS "lap_status_ujian_mhs";
CREATE TABLE "public"."lap_status_ujian_mhs" (
    "id_mahasiswa" integer,
    "nobp" character(14),
    "nm_mahasiswa" character varying(100),
    "status" boolean,
...
DROP TABLE IF EXISTS "lap_peserta_ujian";
CREATE TABLE "public"."lap_peserta_ujian" (
    "id_ujian" integer,
    "id_mahasiswa" integer,
    "nobp" character(14),
    "nm_mahasiswa" character varying(100)
...
DROP TABLE IF EXISTS "lap_jawaban";
CREATE TABLE "public"."lap_jawaban" (
    "id_jawaban" integer,
    "id_ujian" integer,
    "id_soal" integer,
    "id_peserta" integer,
...
DROP TABLE IF EXISTS "lap_user";
CREATE TABLE "public"."lap_user" (
    "id_user" integer,
