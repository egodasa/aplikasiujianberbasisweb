...
--
-- Name: tbpeserta_kuliah_nobp_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mandan
--

ALTER TABLE ONLY tbpeserta_kuliah
    ADD CONSTRAINT tbpeserta_kuliah_nobp_fkey FOREIGN KEY (nobp) REFERENCES tbmahasiswa(nobp) ON UPDATE CASCADE ON DELETE CASCADE;
