...
SELECT pg_catalog.setval('tbhasil_ujian_id_hasil_seq', 2, true);
...
SELECT pg_catalog.setval('tbkelas_ujian_id_kujian_seq', 8, true);
...
SELECT pg_catalog.setval('tbsoal_id_soal_seq', 3, true);
...
SELECT pg_catalog.setval('tbsoal_ujian_id_sujian_seq1', 2, true);
